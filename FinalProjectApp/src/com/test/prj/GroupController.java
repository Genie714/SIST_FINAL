...
public class GroupController
{
   ...
   // 그룹 아이콘 저장할 절대경로 지정
   String PATH = "C:\\Final\\SIST_FINAL\\FinalProjectApp\\WebContent\\images\\img\\icon";
   ...
   public String groupCreationList(Model model, HttpSession session)
   {
      ...
      model.addAttribute("creationIdArr", dao.creationIdArr());
   ...
   public String groupCreationInsert(GroupDTO dto, HttpServletRequest request, Model model, HttpSession session, GroupInviteDTO dtoInvite) throws IOException
   {
      ...
      if (saveFileName != null)
      {
    	  ...
    	  temp = file.getAbsolutePath().replace("C:\\Final\\SIST_FINAL", "");
    	  root = temp.replace("WebContent\\", "");
   ...
   public String GroupInvite(Model model, HttpSession session, HttpServletRequest request)
   {
      String result = "";
   ...
   public String GroupPreInviteController(Model model, GroupInviteDTO dtoInvite, GroupDTO dto, HttpServletRequest request, HttpSession session ) 
   {
      ...
      // TBL_GROUP INSERT
      if (dao.creationGroupMemberCount(create_id) == 5)
      {
