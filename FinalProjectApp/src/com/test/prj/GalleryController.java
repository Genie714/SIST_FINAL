...
public class GalleryController
{
	...
	public String GalleryInsert(Model model, String moment_id, String group_id, String countJoin
								, String settingfiles, String realfiles, String path
								, HttpSession session)
	{
		String result = null;
		String user_id = (String)session.getAttribute("user_id");
		...
		String[] realnames = realfiles.split("///");
		String[] settingnames = settingfiles.split("///");
	...
	public String GalleryRemove(Model model, String group_id, String gallery_id, String moment_id, HttpSession session)
	{
		...
		{
			File file = new File("C:\\Final\\SIST_FINAL\\FinalProjectApp\\WebContent\\images\\img\\gallery\\" + file_settingname);
			if (file.exists())
				file.delete();
